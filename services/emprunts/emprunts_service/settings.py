...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-emprunts-service-key')
...
SERVICE_UTILISATEURS_URL = config('SERVICE_UTILISATEURS_URL', default='http://utilisateurs:8002')
