...
UTILISATEURS = [
    ...
    {'id': 2,  'nom': 'Amadou Diallo',
        'carte': 'PROF001',    'type': 'PROFESSEUR'},
    {'id': 3,  'nom': 'Fatou Ndiaye',
        'carte': 'PROF002',    'type': 'PROFESSEUR'},
    {'id': 4,  'nom': 'Omar Cisse',
        'carte': 'PROF003',    'type': 'PROFESSEUR'},
    {'id': 5,  'nom': 'Aminata Gueye',
        'carte': 'PROF004',    'type': 'PROFESSEUR'},
    {'id': 6,  'nom': 'Cheikh Sy',
        'carte': 'PROF005',    'type': 'PROFESSEUR'},
    {'id': 7,  'nom': 'Moussa Ba',          'carte': 'ETU2026001', 'type': 'ETUDIANT'},
    {'id': 8,  'nom': 'Aissatou Fall',
        'carte': 'ETU2026002', 'type': 'ETUDIANT'},
    {'id': 9,  'nom': 'Ibrahima Sow',
        'carte': 'ETU2026003', 'type': 'ETUDIANT'},
    {'id': 10, 'nom': 'Mariama Kane',
        'carte': 'ETU2026004', 'type': 'ETUDIANT'},
    {'id': 11, 'nom': 'Abdoulaye Diop',
        'carte': 'ETU2026005', 'type': 'ETUDIANT'},
    {'id': 12, 'nom': 'Aida Thiam',         'carte': 'ETU2026006', 'type': 'ETUDIANT'},
    {'id': 13, 'nom': 'Mamadou Diagne',
        'carte': 'ETU2026007', 'type': 'ETUDIANT'},
    {'id': 14, 'nom': 'Khadija Seck',
        'carte': 'ETU2026008', 'type': 'ETUDIANT'},
    {'id': 15, 'nom': 'Oumar Mbaye',
        'carte': 'ETU2026009', 'type': 'ETUDIANT'},
    {'id': 16, 'nom': 'Binta Faye',         'carte': 'ETU2026010', 'type': 'ETUDIANT'},
    {'id': 17, 'nom': 'Lamine Toure',
        'carte': 'ETU2026011', 'type': 'ETUDIANT'},
    ...
    {'id': 21, 'nom': 'Ousseynou Gaye',
        'carte': 'ETU2026015', 'type': 'ETUDIANT'},
    {'id': 22, 'nom': 'Penda Lo',           'carte': 'ETU2026016', 'type': 'ETUDIANT'},
    {'id': 23, 'nom': 'Malick Camara',
        'carte': 'ETU2026017', 'type': 'ETUDIANT'},
    {'id': 24, 'nom': 'Sokhna Ndiaye',
        'carte': 'ETU2026018', 'type': 'ETUDIANT'},
    {'id': 25, 'nom': 'Modou Sene',         'carte': 'ETU2026019', 'type': 'ETUDIANT'},
    {'id': 26, 'nom': 'Ndeye Diatta',
        'carte': 'ETU2026020', 'type': 'ETUDIANT'},
    {'id': 27, 'nom': 'Serigne Thiaw',
        'carte': 'ETU2026021', 'type': 'ETUDIANT'},
    {'id': 28, 'nom': 'Adji Niang',         'carte': 'ETU2026022', 'type': 'ETUDIANT'},
    {'id': 29, 'nom': 'Ousmane Sarr',
        'carte': 'PERS001',    'type': 'PERSONNEL'},
    {'id': 30, 'nom': 'Astou Wade',
        'carte': 'PERS002',    'type': 'PERSONNEL'},
]
...
LIVRES_RAW = [
    ...
    (4,  'Pattern Recognition and ML',
     '9780387310732', 'Christopher Bishop', 'IA'),
    (5,  'Hands-On Machine Learning',
     '9781492032649', 'Aurelien Geron',     'IA'),
    (6,  'Reinforcement Learning',
     '9780262039246', 'Richard Sutton',     'IA'),
    (7,  'Speech and Language Processing',
     '9780131873216', 'Daniel Jurafsky',    'IA'),
    (8,  'Computer Vision',                '9783030343712', 'Richard Szeliski',   'IA'),
    (9,  'Deep Learning with Python',
     '9781617294433', 'Francois Chollet',   'IA'),
    (10, 'Probabilistic Machine Learning',
     '9780262046824', 'Kevin Murphy',       'IA'),
    (11, 'AI: A Modern Approach',
     '9780134610993', 'Peter Norvig',       'IA'),
    (12, "L'IA expliquee",                 '9782845639300', 'Luc Julia',          'IA'),
    (13, 'GANs in Action',                 '9781617295560', 'Jakub Langr',        'IA'),
    (14, 'Transformers for NLP',
     '9781800565791', 'Denis Rothman',      'IA'),
    (15, 'Apprentissage Automatique',
     '9782212679090', 'Massih-Reza Amini',  'IA'),
    (16, 'Python pour la Data Science',
     '9782100790319', 'Jake VanderPlas',    'INFO'),
    (17, 'Algorithmes',                    '9782100767717',
     'Thomas Cormen',      'INFO'),
    (18, 'Clean Code',                     '9780132350884',
     'Robert C. Martin',   'INFO'),
    (19, 'The Pragmatic Programmer',
     '9780135957059', 'David Thomas',       'INFO'),
    (20, 'Design Patterns',                '9780201633610',
     'Erich Gamma',        'INFO'),
    (21, 'Refactoring',                    '9780134757599',
     'Martin Fowler',      'INFO'),
    (22, 'Effective Python',
     '9780134853987', 'Brett Slatkin',      'INFO'),
    (23, 'Designing Data-Intensive Apps',
     '9781449373320', 'Martin Kleppmann',   'INFO'),
    (24, 'Java: The Complete Reference',
     '9781260440232', 'Herbert Schildt',    'INFO'),
    (25, 'Linux: The Complete Reference',
     '9780071496292', 'Richard Petersen',   'INFO'),
    (26, 'Computer Networks',
     '9780132126953', 'Andrew Tanenbaum',   'INFO'),
    (27, 'Operating System Concepts',
     '9781119320913', 'Abraham Silberschatz', 'INFO'),
    (28, 'Cracking the Coding Interview',
     '9780984782857', 'Gayle McDowell',     'INFO'),
    (29, "You Don't Know JS",
     '9781491904244', 'Kyle Simpson',       'INFO'),
    (30, 'Docker en Pratique',
     '9782100787654', 'Pierre-Yves Cloux',  'INFO'),
    (31, 'Probabilites et Statistiques',
     '9782100715671', 'Hennequin',          'MATH'),
    (32, 'Algebre Lineaire',
     '9782705681142', 'Joseph Grifone',     'MATH'),
    (33, 'Analyse pour la Licence',
     '9782100727216', 'Daniel Fredon',      'MATH'),
    (34, 'Mathematics for Machine Learning',
     '9781108455145', 'Marc Deisenroth',  'MATH'),
    (35, 'Linear Algebra Done Right',
     '9783319110790', 'Sheldon Axler',      'MATH'),
    (36, 'Convex Optimization',
     '9780521833783', 'Stephen Boyd',       'MATH'),
    (37, 'Calculus',                       '9780914098911',
     'Michael Spivak',     'MATH'),
    (38, 'Discrete Mathematics',
     '9780073383095', 'Kenneth Rosen',      'MATH'),
    (39, 'Theorie des Graphes',
     '9782705694326', 'Aimee Lombardi',     'MATH'),
    (40, 'Numerical Recipes',
     '9780521880688', 'William Press',      'MATH'),
    (41, 'Physique Generale',
     '9782761332293', 'Hugh Young',         'SCI'),
    (42, 'Chimie Organique',
     '9782761379892', 'Paula Bruice',       'SCI'),
    (43, 'Biologie Moleculaire',
     '9782807304277', 'James Watson',       'SCI'),
    (44, 'A Brief History of Time',
     '9780553380163', 'Stephen Hawking',    'SCI'),
    (45, 'The Selfish Gene',
     '9780198788607', 'Richard Dawkins',    'SCI'),
    (46, 'Les Miserables',                 '9782070409228', 'Victor Hugo',        'LIT'),
    (47, 'Les Soleils des Independances',
     '9782020025348', 'Ahmadou Kourouma',   'LIT'),
    (48, 'Une si longue lettre',
     '9782723601658', 'Mariama Ba',         'LIT'),
    (49, "L'Aventure ambigue",
     '9782264025203', 'Cheikh Hamidou Kane', 'LIT'),
...
PROBA_CATEGORIE = ['IA', 'IA', 'IA', 'INFO',
                   'INFO', 'INFO', 'MATH', 'MATH', 'SCI', 'LIT']
PREF_UTILISATEUR = {u['id']: random.choice(
    PROBA_CATEGORIE) for u in UTILISATEURS}
