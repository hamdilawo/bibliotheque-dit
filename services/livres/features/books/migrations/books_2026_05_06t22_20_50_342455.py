<<<<<<< HEAD:services/livres/features/books/migrations/books_2026_05_05t17_35_03_680952.py
...
class Categorie(Table, tablename="categorie", schema=None):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
async def forwards():
    manager = MigrationManager(
        migration_id=ID, app_name="books", description=DESCRIPTION
    )
    ...
    manager.add_column(
        table_class_name="Livre",
        tablename="livre",
        column_name="annee_publication",
        db_column_name="annee_publication",
    ...
    manager.add_column(
        table_class_name="Livre",
        tablename="livre",
        column_name="couverture_url",
        db_column_name="couverture_url",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 500,
...
async def forwards():
    ...
    return manager
>>>>>>> origin/books/develop:services/livres/features/books/migrations/books_2026_05_06t22_20_50_342455.py
